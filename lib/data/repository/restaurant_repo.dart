...
class RestaurantRepo {
  ...
  Future<Response> updateRestaurant(Restaurant restaurant, XFile? logo, XFile? cover, String token) async {
    ...
    _fields.addAll(<String, String>{
      '_method': 'put', 'name': restaurant.name!, 'contact_number': restaurant.phone!, 'schedule_order': restaurant.scheduleOrder==true ? '1' : '0',
      'address': restaurant.address!, 'minimum_order': restaurant.minimumOrder.toString(), 'delivery': restaurant.delivery==true ? '1' : '0',
      'take_away': restaurant.takeAway==true ? '1' : '0', 'gst_status': restaurant.gstStatus==true ? '1' : '0', 'gst': restaurant.gstCode!,
