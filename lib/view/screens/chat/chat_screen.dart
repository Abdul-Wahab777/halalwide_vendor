  ...
  Widget build(BuildContext context) {
    return GetBuilder<ChatController>(builder: (chatController) {
      ...
      return Scaffold(
        ...
        body: _isLoggedIn ==true? SafeArea(
          child: Center(
            child: Container(
              ...
              child: Column(children: [
                ...
                GetBuilder<ChatController>(builder: (chatController) {
                    return Expanded(child: chatController.messageModel != null ? chatController.messageModel!.messages!.length > 0 ? SingleChildScrollView(
                      ...
                      child: PaginatedListView(
                        ...
                        totalSize: chatController.messageModel != null ? chatController.messageModel!.totalSize! : 0,
                        offset: chatController.messageModel != null ? chatController.messageModel!.offset! : 0,
                ...
                (chatController.messageModel != null && (chatController.messageModel?.status==true || chatController.messageModel!.messages!.length <= 0)) ?  Container(
                  color: Theme.of(context).cardColor,
                  child: Column(children: [
