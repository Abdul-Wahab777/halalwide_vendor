      ...
      child: Container(
        ...
        child: Row(children: [
          ...
          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
            ...
            Text(campaignModel.title.toString(), style: robotoMedium, maxLines: 1, overflow: TextOverflow.ellipsis),
              ...
              InkWell(
                onTap: () {
                  Get.dialog(ConfirmationDialog(
                    icon: Images.warning, description: campaignModel.isJoined==true ? 'are_you_sure_to_leave'.tr : 'are_you_sure_to_join'.tr,
                    onYesPressed: () {
                      if(campaignModel.isJoined==true) {
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: campaignModel.isJoined==true ? Theme.of(context).secondaryHeaderColor : Theme.of(context).primaryColor,
                    borderRadius: BorderRadius.circular(Dimensions.RADIUS_SMALL),
                  ),
                  child: Text(campaignModel.isJoined ==true? 'leave_now'.tr : 'join_now'.tr, textAlign: TextAlign.center, style: robotoBold.copyWith(
                    color: Theme.of(context).cardColor,
