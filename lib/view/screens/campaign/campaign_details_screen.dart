  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(children: [
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Row(children: [
                ...
                Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  Text(
                    campaignModel.title.toString(), style: robotoMedium.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE),
        ...
        CustomButton(
          buttonText: campaignModel.isJoined==true ? 'leave_now'.tr : 'join_now'.tr,
