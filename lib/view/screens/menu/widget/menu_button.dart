...
class MenuButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      onTap: () {
        if(menu.isBlocked==true) {
          showCustomSnackBar('this_feature_is_blocked_by_admin'.tr);
        }else if(menu.isNotSubscribe==true){
      ...
      child: Column(children: [
        ...
        Text(menu.title.toString(), style: robotoMedium.copyWith(fontSize: Dimensions.FONT_SIZE_SMALL), textAlign: TextAlign.center),
