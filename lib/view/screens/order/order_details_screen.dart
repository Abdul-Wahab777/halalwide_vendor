  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: GetBuilder<OrderController>(builder: (orderController) {
        ...
        bool _showSlider = _controllerOrderModer != null ? (_controllerOrderModer.orderStatus == 'pending' && (_controllerOrderModer.orderType == 'take_away' || _restConfModel || _selfDelivery==true))
            ...
            || (_controllerOrderModer.orderStatus == 'handover' && (_selfDelivery==true || _controllerOrderModer.orderType == 'take_away')) : false;
        ...
        return (orderController.orderDetailsModel != null && _controllerOrderModer != null && _restaurant != null) ? Column(children: [
            ...
            child: Center(child: SizedBox(width: 1170, child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Row(children: [
                ...
                Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  Text(
                    _order.deliveryAddress!.contactPersonName.toString(), maxLines: 1, overflow: TextOverflow.ellipsis,
                    style: robotoRegular.copyWith(fontSize: Dimensions.FONT_SIZE_SMALL),
                  ),
                  Text(
                    _order.deliveryAddress!.address.toString(), maxLines: 1, overflow: TextOverflow.ellipsis,
                    style: robotoRegular.copyWith(fontSize: Dimensions.FONT_SIZE_SMALL, color: Theme.of(context).disabledColor),
                  ),
                ...
                SizedBox(height: Dimensions.PADDING_SIZE_SMALL),
                  ...
                  Row(children: [
                    ...
                    Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      Text(
                        _order.deliveryMan!.email.toString(), maxLines: 1, overflow: TextOverflow.ellipsis,
                        style: robotoRegular.copyWith(fontSize: Dimensions.FONT_SIZE_SMALL, color: Theme.of(context).disabledColor),
                      ),
                    ])),
          ...
          || _restConfModel || _selfDelivery==true) && _cancelPermission) ? Padding(
            padding: EdgeInsets.all(Dimensions.PADDING_SIZE_SMALL),
            child: Row(children: [
            ...
            action: () {
              if(_controllerOrderModer.orderStatus == 'pending' && (_controllerOrderModer.orderType == 'take_away'
                  || _restConfModel || _selfDelivery==true))  {
                Get.dialog(ConfirmationDialog(
                  icon: Images.warning, title: 'are_you_sure_to_confirm'.tr, description: 'you_want_to_confirm_this_order'.tr,
                  onYesPressed: () {
                    orderController.updateOrderStatus(_controllerOrderModer.id!, 'confirmed', back: true).then((success) {
              ...
              }else if((_controllerOrderModer.orderStatus == 'handover' && (_controllerOrderModer.orderType == 'take_away' || _selfDelivery==true))) {
                if (Get.find<SplashController>().configModel.orderDeliveryVerification==true
            ...
            label: Text(
              (_controllerOrderModer.orderStatus == 'pending' && (_controllerOrderModer.orderType == 'take_away'
                  ...
                  : (_controllerOrderModer.orderStatus == 'handover' && (_controllerOrderModer.orderType == 'take_away' || _selfDelivery==true))
