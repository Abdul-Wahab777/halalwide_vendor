  ...
  Widget build(BuildContext context) {
    return GetBuilder<AuthController>(builder: (authController) {
      ...
      return Card(
        elevation: 0,
        child: Padding(
          padding: EdgeInsets.all(widget.fromView==true ? 0 : Dimensions.PADDING_SIZE_SMALL),
              ...
              child: DropdownButton<int>(
                ...
                items: _zoneIndexList.map((int value) {
                  return DropdownMenuItem<int>(
                    value: value,
                    child: Text(authController.zoneList[value].name.toString()),
                  );
                }).toList(),
                onChanged: (value) {
                  // _polygons = HashSet();
