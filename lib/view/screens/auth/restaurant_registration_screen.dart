                    ...
                    Align(alignment: Alignment.center, child: Stack(children: [
                      ClipRRect(
                        ...
                        child: authController.pickedLogo != null ? GetPlatform.isWeb ? Image.network(
                          authController.pickedLogo!.path.toString(), width: 150, height: 120, fit: BoxFit.cover,
                        ) : Image.file(
                          File(authController.pickedLogo!.path.toString()), width: 150, height: 120, fit: BoxFit.cover,
                        ) : Image.asset(
