              ...
              child: SizedBox(
                ...
                child: GetBuilder<AuthController>(builder: (authController) {
                  ...
                  return Column(children: [
                    ...
                    SizedBox(height: Get.find<SplashController>().configModel.toggleRestaurantRegistration==true ? Dimensions.PADDING_SIZE_SMALL : 0),

                    Get.find<SplashController>().configModel.toggleRestaurantRegistration==true ? TextButton(
