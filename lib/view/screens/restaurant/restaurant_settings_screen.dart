          ...
          Expanded(child: SingleChildScrollView(
            ...
            child: Column(children: [
              ...
              MyTextField(
                ...
                inputAction: _restaurant?.selfDeliverySystem == 1 ? TextInputAction.none : TextInputAction.done,
              ...
              Get.find<SplashController>().configModel.toggleVegNonVeg ==true? Align(alignment: Alignment.centerLeft, child: Text(
                'food_type'.tr,
                style: robotoRegular.copyWith(fontSize: Dimensions.FONT_SIZE_SMALL, color: Theme.of(context).disabledColor),
              )) : SizedBox(),
              Get.find<SplashController>().configModel.toggleVegNonVeg==true ? Row(children: [
              ...
              Get.find<SplashController>().configModel.scheduleOrder==true ? SwitchButton(icon: Icons.alarm_add, title: 'schedule_order'.tr, isButtonActive: widget.restaurant.scheduleOrder, onTap: () {
                _restaurant?.scheduleOrder = !_restaurant!.scheduleOrder!;
              }) : SizedBox(),
              SizedBox(height: Get.find<SplashController>().configModel.scheduleOrder==true ? Dimensions.PADDING_SIZE_SMALL : 0),
              ...
              Stack(children: [
                ClipRRect(
                  ...
                  child: restController.pickedCover != null ? GetPlatform.isWeb ? Image.network(
                    ...
                    File(restController.pickedCover!.path.toString()), width: context.width, height: 170, fit: BoxFit.cover,
                  ) : FadeInImage.assetNetwork(
