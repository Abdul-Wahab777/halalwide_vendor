...
class ProductDetailsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if(Get.find<AuthController>().profileModel?.restaurants?[0].reviewsSection==true) {
    ...
    return Scaffold(
      ...
      body: GetBuilder<RestaurantController>(builder: (restController) {
        return Column(children: [
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Row(children: [
                ...
                Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  Text(
                    product.name.toString(), style: robotoMedium.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE),
                  ...
                  Row(children: [
                    ...
                    Get.find<SplashController>().configModel.toggleVegNonVeg ==true? Container(
              ...
              product.addOns!.length > 0 ? ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return Row(children: [
                    ...
                    Text(product.addOns![index].name.toString()+':', style: robotoRegular.copyWith(fontSize: Dimensions.FONT_SIZE_SMALL)),
                    SizedBox(width: Dimensions.PADDING_SIZE_EXTRA_SMALL),
                    Text(
              ...
              (product.description != null && product.description!.isNotEmpty) ? Column(
                ...
                children: [
                  ...
                  SizedBox(height: Dimensions.PADDING_SIZE_EXTRA_SMALL),
                  Text(product.description.toString(), style: robotoRegular),
                  SizedBox(height: Dimensions.PADDING_SIZE_LARGE),
                ],
              ) : SizedBox(),

              Get.find<AuthController>().profileModel?.restaurants?[0].reviewsSection==true ? Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
          ...
          CustomButton(
            onPressed: () {
              if(Get.find<AuthController>().profileModel?.restaurants?[0].foodSection==true) {
                // TODO: add product
