  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(mainAxisSize: MainAxisSize.min, children: [
        ...
        Text(
          Get.find<AuthController>().profileModel!.branch.toString(),
          style: robotoRegular.copyWith(color: Theme.of(context).disabledColor, fontSize: Dimensions.FONT_SIZE_SMALL),
        ),
        SizedBox(height: Dimensions.PADDING_SIZE_EXTRA_SMALL),

        Text(
          Get.find<AuthController>().profileModel!.accountNo.toString(),
        ...
        TextField(
          ...
          decoration: InputDecoration(
            ...
            prefixIcon: Text(
              Get.find<SplashController>().configModel.currencySymbol.toString(),
