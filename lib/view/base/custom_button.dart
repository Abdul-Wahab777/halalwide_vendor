...
class CustomButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final ButtonStyle _flatButtonStyle = TextButton.styleFrom(
      backgroundColor: onPressed == null ? Theme.of(context).disabledColor : transparent==true
    ...
    return Padding(
      ...
      child: TextButton(
        ...
        child: Text(buttonText ??'', textAlign: TextAlign.center, style: robotoBold.copyWith(
          color: transparent==true ? Theme.of(context).primaryColor : Theme.of(context).cardColor,
